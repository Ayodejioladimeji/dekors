          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link
                ...
                className={`nav-link ${router.asPath.includes("/dashboard/address-book") && "active"}`}
              >
            ...
            <li className="nav-item">
              <Link
                ...
                className={`nav-link ${router.asPath.includes("/dashboard/profile-settings") && "active"}`}
              >
            ...
            <li className="nav-item">
              <Link
                ...
                className={`nav-link ${router.asPath.includes("/dashboard/change-password") && "active"}`}
              >
